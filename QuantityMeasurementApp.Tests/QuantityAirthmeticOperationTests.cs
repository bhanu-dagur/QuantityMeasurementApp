...
namespace QuantityMeasurementApp.Tests
{
    ...
    public class QuantityRefactoringTests
    {
        ...
        public void TestAdd_NullOperand()
        {
            ...
            Assert.Throws<NullReferenceException>(() => q1.Add(null));
        }
        ...
        public void TestSubtract_NullOperand()
        {
            ...
            Assert.Throws<NullReferenceException>(() => q1.Subtract(null));
        }
        ...
        public void TestDivide_NullOperand()
        {
            ...
            Assert.Throws<NullReferenceException>(() => q1.Divide(null));
        }
